...
const sitemap = new SitemapStream({ hostname: 'https://dev.dkdb.cz' });

sitemap.write({ url: '/', changefreq: 'weekly', priority: 0.7 });
sitemap.write({ url: '/knihy', changefreq: 'weekly', priority: 1 });
slugs.forEach(slug => {
  sitemap.write({ url: `kniha/${slug}`, changefreq: 'monthly', priority: 0.8 });
});
sitemap.write({ url: '/nahodna-kniha', changefreq: 'always', priority: 0.4 });
sitemap.write({ url: '/o-projektu', changefreq: 'monthly', priority: 0.3 });
